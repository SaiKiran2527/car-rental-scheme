<%-- 
    Document   : admintab
    Created on : 02-Sep-2020, 10:01:40 pm
    Author     : sathvika
--%>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:290px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="adminrentcarstabup.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-columns w3-margin-right"></i>CARS RENTED</a>
        <a href="admintab.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-list-alt w3-margin-right"></i>LENDS/RENTS</a>
...
<div class="w3-container">
  ...
  <h2>LIST OF CARS LENDED/RENTED</h2>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<style>
body {margin:0;}
  ...
  <table class="w3-table-all">
    ...
    <%
       ...
       try {
            ...
            String q="select * from carrents order by tid desc;";
            ...
            while(re.next()){
                ...
                out.print("<td>"+vno+"</td><td>"+vname+"</td><td>"+rname+"</td><td>"+unam+"</td><td>"+date+"</td><td>"+rdate+"</td><td>"+price+"</td></tr>");
