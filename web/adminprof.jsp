<%-- 
    Document   : adminprof
    Created on : 02-Sep-2020, 8:45:27 pm
    Author     : sathvika
--%>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:290px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="adminprof.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>ALL CARS</a> 
    
	<a href="adminrentcarstabup.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-columns w3-margin-right"></i>ALL CARS RENTED</a>
  ...
  <!-- First Photo Grid-->
    ...
    <%
       ...
       try {
            ...
            String q="select * from carlends order by tid desc;";
            ...
            out.print(vno+"</li>");
                ...
                out.println(unam+"</span>");
                out.print("</li><li class='w3-light-grey w3-padding-24'>");
                String s="";
                if(status.equals("0")){
                out.print("<form action='adminconfdel.jsp' method='post'><input type='hidden' name='hid' value='"+re.getString("vno")+"'><input type='submit' value='BLOCK' class='w3-button w3-teal w3-padding-large w3-hover-black'></form>");
                out.print("</li></ul></div>");}
                if(status.equals("3")){
                out.print("<form action='adminconfunblo.jsp' method='post'><input type='hidden' name='hid' value='"+re.getString("vno")+"'><input type='submit' value='UNBLOCK THE CAR' class='w3-button w3-teal w3-padding-large w3-hover-black'></form>");
                out.print("</li></ul></div>");}
                if(status.equals("1")){
