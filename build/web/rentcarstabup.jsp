<%-- 
    Document   : rentcarstabup
    Created on : 27-Aug-2020, 6:01:39 pm
    Author     : sathvika
--%>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:290px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	...
	<a href="rentcarstabup.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-columns w3-margin-right"></i>CARS RENTED</a>
...
window.onclick = function(event) {
  ...
  <!-- First Photo Grid-->
    ...
    <h4>Yours cars that are currently rented</h4>
    <!-- Pricing Tables -->
    ...
    <%
       ...
       try {
            ...
            String q="select * from carrents where uname='"+unn+"' and status IN('0','2') order by tid desc;";
            ...
            while(re.next()){
                ...
                String stat = re.getString("status");
                if(swe%3==0){
            ...
            out.print(vno+"</li>");
                ...
                if(stat.equals("2")){
                out.print("<form action='returnaprov.jsp' method='post'><input type='hidden' name='hidd' value='"+re.getString("price")+"'><input type='hidden' name='hid' value='"+re.getString("vno")+"'><input type='submit' value='RETURNED BY RENTER' class='w3-button w3-teal w3-padding-large w3-hover-black'></form>");
                out.print("</li></ul></div>");
                }
                if(swe%3==2){
                    out.print("</div>");
