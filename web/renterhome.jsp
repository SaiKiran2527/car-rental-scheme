<%-- 
    Document   : renterhome
    Created on : 27-Aug-2020, 6:00:36 pm
    Author     : sathvika
--%>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:290px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    <a href="renterhome.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>AVAILABLE</a> 
  ...
  <header id="portfolio">
    ...
    <%
       ...
       try {
            ...
            String q="select * from carlends where status='0' order by tid desc;";
            ...
            out.print(vno+"</li>");
                ...
                String s="";
                out.print("<form action='confrent.jsp' method='post'><input type='hidden' name='hid' value='"+re.getString("vno")+"'><input type='submit' value='RENT' class='w3-button w3-teal w3-padding-large w3-hover-black'></form>");
                out.print("</li></ul></div>");
                if(swe%3==2){
                    out.print("</div>");
                }
